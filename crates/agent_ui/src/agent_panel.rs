...
use language_model::{
    CompletionIntent, ConfigurationError, ConfiguredModel, LanguageModelProviderTosView, LanguageModelRegistry
};
...
use zed_actions::{
    ...
    agent::{OpenSettings, ResetOnboarding, ToggleModelSelector},
