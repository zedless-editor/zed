...
impl From<CompletionMode> for language_model::CompletionMode {
    fn from(value: CompletionMode) -> Self {
        match value {
            CompletionMode::Normal => language_model::CompletionMode::Normal,
            CompletionMode::Burn => language_model::CompletionMode::Max,
        }
    }
}
